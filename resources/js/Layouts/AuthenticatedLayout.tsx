        ...
        <div className="flex h-screen bg-slate-50 font-sans text-slate-900 overflow-hidden">
            ...
            >
                ...
                <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            {facilityMenuOpen && (
                                <div className="pl-4 pr-2 py-1 space-y-1 relative">
                                    ...
                                    <Link href={route("buildings.index")} className={`flex items-center gap-3 px-10 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wide transition-colors ${route().current("buildings.*") ? "bg-blue-700 text-white shadow-sm" : "text-slate-400 hover:bg-slate-800 hover:text-white"}`}>Buildings</Link>
                                    <Link href={route("floors.index")} className={`flex items-center gap-3 px-10 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wide transition-colors ${route().current("floors.*") ? "bg-blue-700 text-white shadow-sm" : "text-slate-400 hover:bg-slate-800 hover:text-white"}`}>Floors</Link>
                                    <Link href={route("stalls.index")} className={`flex items-center gap-3 px-10 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wide transition-colors ${route().current("stalls.*") ? "bg-blue-700 text-white shadow-sm" : "text-slate-400 hover:bg-slate-800 hover:text-white"}`}>Stalls</Link>
                                </div>
                            )}
                        </div>
                    )}
                    ...
                    {hasPermission('view reports') && (
                        <div className="flex flex-col space-y-1">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <Icon icon="solar:clipboard-list-bold-duotone" className="w-6 h-6 text-rose-500" />
                                    LGU Reports
                                </div>
                            ...
                            {reportsMenuOpen && (
                                <div className="pl-4 pr-2 py-1 space-y-1 relative">
                                    <div className="absolute left-[31px] top-2 bottom-2 w-0.5 bg-slate-700 rounded-full"></div>
                                    <Link href={route("reports.master_ledger")} className={`flex items-center gap-3 px-10 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wide transition-colors ${route().current("reports.master_ledger") ? "bg-rose-700 text-white shadow-sm" : "text-slate-400 hover:bg-slate-800 hover:text-white"}`}>Master Ledger</Link>
                                    <Link href={route("reports.balances")} className={`flex items-center gap-3 px-10 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wide transition-colors ${route().current("reports.balances") ? "bg-rose-700 text-white shadow-sm" : "text-slate-400 hover:bg-slate-800 hover:text-white"}`}>With Balances</Link>
                                    <Link href={route("reports.closures")} className={`flex items-center gap-3 px-10 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wide transition-colors ${route().current("reports.closures") ? "bg-rose-700 text-white shadow-sm" : "text-slate-400 hover:bg-slate-800 hover:text-white"}`}>For Closure</Link>
                                </div>
                            )}
                        </div>
                    )}
                    ...
                    {/* Map */}
                    {hasPermission('manage facilities') && (
                        <Link href={route("layouts.mapper")} className={`flex items-center gap-3 px-4 py-3.5 rounded-xl font-black text-sm uppercase border-2 transition-colors ${route().current("layouts.mapper") ? "bg-blue-700 text-white border-blue-900 shadow-sm" : "border-transparent hover:bg-slate-800 hover:text-white"}`}>
                    ...
                    {hasPermission('manage tenants') && (
                        <Link href={route("tenants.index")} className={`flex items-center gap-3 px-4 py-3.5 rounded-xl font-black text-sm uppercase border-2 transition-colors ${route().current("tenants.*") ? "bg-blue-700 text-white border-blue-900 shadow-sm" : "border-transparent hover:bg-slate-800 hover:text-white"}`}>
                    ...
                    {hasPermission('view contracts') && (
                        <Link href={route("contracts.index")} className={`flex items-center gap-3 px-4 py-3.5 rounded-xl font-black text-sm uppercase border-2 transition-colors ${route().current("contracts.*") ? "bg-blue-700 text-white border-blue-900 shadow-sm" : "border-transparent hover:bg-slate-800 hover:text-white"}`}>
                    ...
                    {hasPermission('manage payments') && (
                        <Link href={route("payments.index")} className={`flex items-center gap-3 px-4 py-3.5 rounded-xl font-black text-sm uppercase border-2 transition-colors ${route().current("payments.*") ? "bg-blue-700 text-white border-blue-900 shadow-sm" : "border-transparent hover:bg-slate-800 hover:text-white"}`}>
                    ...
                    {hasPermission('manage users') && (
                        <Link href={route("users.index")} className={`flex items-center gap-3 px-4 py-3.5 rounded-xl font-black text-sm uppercase border-2 transition-colors ${route().current("users.*") ? "bg-blue-700 text-white border-blue-900 shadow-sm" : "border-transparent hover:bg-slate-800 hover:text-white"}`}>
                ...
                <div className="p-4 border-t-2 border-slate-800 bg-slate-950 shrink-0">
                    ...
                    <Link href={route("logout")} method="post" as="button" className="mt-2 flex items-center justify-center gap-2 w-full py-3 bg-rose-500/10 border-2 border-rose-500/30 text-rose-500 rounded-xl font-black uppercase text-sm tracking-wide hover:bg-rose-600 hover:border-rose-800 hover:text-white transition-all">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative bg-slate-50">
                <div className="lg:hidden bg-white shadow-sm h-16 flex items-center justify-between px-4 border-b-2 border-slate-300 shrink-0 z-10">
                    <div className="flex items-center gap-3">
                        <button onClick={() => setSidebarOpen(true)} className="text-slate-600 hover:text-slate-900 focus:outline-none bg-slate-100 border-2 border-slate-300 p-1.5 rounded-lg transition-colors">
