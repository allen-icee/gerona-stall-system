...
export default function AuthenticatedLayout({ children }: PropsWithChildren) {
    ...
    // ✅ SAFE DEBUG (optional)
    console.log("ToastListener:", ToastListener);
    ...
    return (
        <div className="flex h-screen bg-slate-50 font-sans text-slate-900 overflow-hidden">
            ...
            >
                ...
                <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-2">
                        ...
                        {facilityMenuOpen && (
                            <div className="pl-4 pr-2 py-1 space-y-1 relative">
                                ...
                                <Link
                                    ...
                                    className={`flex items-center gap-3 px-10 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wide transition-colors ${
                                        route().current("buildings.*")
                    ...
                    <Link
                        ...
                        className="flex items-center gap-3 px-4 py-3.5 rounded-xl font-black text-sm uppercase border-2 border-transparent hover:bg-slate-800 hover:text-white transition-colors"
                    >
                        <Icon
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative bg-slate-50">
                {/* ✅ RESTORED: Mobile-Only Top Bar (For Hamburger Menu) */}
