//resources\js\Pages\Reports\Balances.tsx
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm font-bold text-slate-500">
                            Tenants currently owing monthly rent or missing
                ...
                <div className="flex flex-wrap items-center gap-3 bg-white p-3 rounded-xl border-2 border-slate-300 shadow-sm">
                    ...
                    <div className="relative flex-1 min-w-[200px]">
                        ...
                        <input
                            ...
                            className="block w-full pl-10 pr-3 py-2 border-2 border-slate-300 rounded-lg text-sm font-bold text-slate-900 placeholder-slate-400 focus:ring-0 focus:border-rose-600 transition-colors"
                    ...
                    <div className="overflow-x-auto custom-scrollbar">
                        <table className="w-full text-left text-sm whitespace-nowrap">
                            <thead className="bg-slate-800 text-slate-300 font-black uppercase text-[10px] tracking-wider border-b-2 border-slate-900">
                                <tr>
                                    <th className="px-4 py-3 border-r border-slate-700 text-center">
                                        Tenant Name
                                    </th>
                                    <th className="px-4 py-3 border-r border-slate-700 text-center">
                                        Stall & Location
                                    ...
                                    <th className="px-4 py-3 border-r-2 border-slate-700 text-center text-rose-400 bg-rose-900/30">
                                        Total Debt
                                    </th>
                            ...
                            <tbody className="divide-y-2 divide-slate-200">
                                {balances.length === 0 ? (
                                    <tr>
                                        ...
                                        >
                                            ...
                                            <p className="text-emerald-700">
                                                All accounts are fully paid! No
                                    ...
                                    balances.map((record: any) => (
                                        ...
                                        >
                                            <td className="px-4 py-4 font-black text-slate-900 border-r border-slate-200 text-center">
                                                {record.tenant_name}
                                            </td>
