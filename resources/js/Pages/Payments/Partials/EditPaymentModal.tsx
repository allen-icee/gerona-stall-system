                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-amber-50 border-2 border-amber-300 rounded-lg px-4 py-2.5 text-sm font-black text-amber-900 focus:border-amber-600 focus:ring-0 transition-colors"
                            required
                        />
                        {errors.or_number && (
