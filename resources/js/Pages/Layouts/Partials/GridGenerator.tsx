//resources\js\Pages\Layouts\Partials\GridGenerator.tsx
        ...
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border-2 border-slate-200">
            <div className="text-center mb-6">
                <Icon
                    ...
                    className="w-16 h-16 mx-auto mb-2 text-amber-500"
                />
                <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">
                    Generate Map Grid
                </h2>
                <p className="text-sm text-slate-500 font-bold">
                    Set the dimensions for this floor's physical layout.
                </p>
            </div>
            <form onSubmit={onSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    disabled={processing}
                    className="w-full bg-amber-500 hover:bg-amber-600 text-slate-900 font-black uppercase py-3 rounded-lg mt-4 shadow-sm border-b-4 border-amber-700 transition-colors"
                >
                    Create Blank Grid
                </button>
            </form>
