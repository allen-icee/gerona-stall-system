...
export default function BuildingsIndex({ buildings, filters }: any) {
    ...
    const [sortFilter, setSortFilter] = useState(
        filters?.sort ? `${filters.sort}_${filters.direction}` : "name_asc",
    );
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-xs font-bold text-slate-500">
                            Add a Building before adding floors and stalls.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="relative w-full md:w-64">
                            ...
                            <input
                                ...
                                className="block w-full pl-10 pr-3 py-2.5 border-2 border-slate-300 rounded-lg text-sm font-bold text-slate-900 placeholder-slate-400 focus:border-blue-700 focus:ring-0"
                        ...
                        <button
                            ...
                            className="flex items-center justify-center p-2.5 text-emerald-700 bg-emerald-100 rounded-lg border-2 border-emerald-300 hover:bg-emerald-200"
                        ...
                        <button
                            ...
                            className="flex items-center justify-center p-2.5 text-amber-700 bg-amber-100 rounded-lg border-2 border-amber-300 hover:bg-amber-200"
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-blue-700 hover:bg-blue-800 border-2 border-blue-900 text-white font-black uppercase text-xs tracking-wide px-5 py-2.5 rounded-lg shadow-sm"
                        >
                            <Icon
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex justify-center gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-100 border-2 border-blue-400 text-blue-800 hover:bg-blue-200 hover:border-blue-600 rounded transition-colors text-xs font-extrabold uppercase tracking-wide"
                                                            title="Edit Building"
                                                        >
                                                            <Icon
                                                                icon="solar:pen-bold"
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center gap-1.5 px-3 py-1.5 bg-rose-100 border-2 border-rose-400 text-rose-800 hover:bg-rose-200 hover:border-rose-600 rounded transition-colors text-xs font-extrabold uppercase tracking-wide"
                                                            title="Delete Building"
                                                        >
                                                            <Icon
