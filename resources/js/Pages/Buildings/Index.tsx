                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="relative w-full md:w-64">
                            ...
                            <input
                                ...
                                className="block w-full pl-10 pr-3 py-2.5 border-2 border-slate-300 rounded-lg text-sm font-bold text-slate-900 placeholder-slate-400 focus:border-blue-700 focus:ring-0 transition-colors"
                        ...
                        <button
                            ...
                            className="flex items-center justify-center p-2.5 text-emerald-700 bg-emerald-100 rounded-lg border-2 border-emerald-300 hover:bg-emerald-200 transition-colors"
                        ...
                        <button
                            ...
                            className="flex items-center justify-center p-2.5 text-amber-700 bg-amber-100 rounded-lg border-2 border-amber-300 hover:bg-amber-200 transition-colors"
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-blue-700 hover:bg-blue-800 border-2 border-blue-900 text-white font-black uppercase text-xs tracking-wide px-5 py-2.5 rounded-lg shadow-sm transition-colors"
                        >
                            <Icon
                                    ...
                                    buildings.data.map(
                                        (building: any, index: number) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-2 font-black text-slate-900 border-r border-slate-200 text-center text-base uppercase">
                                                    {building.name}
                                                </td>

                                                <td className="px-4 py-2 border-r border-slate-200 text-slate-600 text-sm text-center whitespace-normal max-w-xs">
