                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        {canManageContracts && (
                            <button
                                ...
                                className="flex items-center gap-2 bg-blue-700 hover:bg-blue-800 border-2 border-blue-900 text-white font-black uppercase text-xs tracking-wide px-5 py-2.5 rounded-lg shadow-sm shrink-0"
                            >
                                <Icon
                        ...
                        <table className="w-full text-left text-sm whitespace-nowrap">
                            {viewMode === "standard" ? (
                                ...
                                <thead className="bg-slate-800 text-slate-300 font-black uppercase text-[10px] tracking-wider border-b-2 border-slate-900">
                                    <tr>
                                        <th className="px-4 py-3 sticky left-0 bg-slate-900 z-10 border-r-2 border-slate-700 text-center">
                                            Entity Details
                                        </th>
                                        ...
                                        {monthsList.map((m) => (
                                            <th
                                                key={m}
                                                className="px-3 py-3 text-center border-r border-slate-700 text-emerald-400"
                                            >
                                                {m}
                                            </th>
                                        ))}
                                        <th className="px-4 py-3 text-center sticky right-0 bg-slate-900 z-10">
                                            Act
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    contracts.data.map(
                                        (contract: any, index: number) => (
                                            ...
                                            >
                                                ...
                                                {viewMode === "ledger" && (
                                                    <>
                                                        ...
                                                        <td className="px-4 py-3 text-center bg-rose-50/30 border-r-2 border-slate-300">
                                                            <span
                                                                className={`font-black text-xs ${contract.outstanding_balance > 0 ? "text-rose-600" : "text-emerald-600"}`}
                                                            >
                                                                {contract.outstanding_balance >
                                                                0
                                                                    ? `₱ ${Number(contract.outstanding_balance).toLocaleString()}`
                                                                    : "CLEARED"}
                                                            </span>
                                                        </td>
                                                        {monthsList.map((m) => {
                                                            ...
                                                            return (
                                                                <td
                                                                    key={m}
                                                                    className={`px-3 py-3 text-center border-r border-slate-200 text-xs font-bold ${paidInMonth > 0 ? "bg-emerald-50 text-emerald-700" : "text-slate-300"}`}
                                                                >
                                                                    {paidInMonth >
                                                                    0
                                                                        ? `₱ ${Number(paidInMonth).toLocaleString()}`
                                                                        : "-"}
                                                                </td>
                                                            );
                                                        })}
                                                ...
                                                <td
                                                    className={`px-4 py-3 text-center ${viewMode === "ledger" ? "sticky right-0 bg-white shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.05)] border-l-2 border-slate-300" : ""}`}
                                                >
                                                    {canManageContracts ? (
