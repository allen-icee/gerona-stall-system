                    ...
                    <div className="bg-rose-100 border-2 border-rose-400 p-4 rounded-xl flex items-start gap-3 shadow-sm animate-pulse">
                        ...
                        <div>
                            <h3 className="text-sm font-black text-rose-800 uppercase tracking-wide">
                                Late Renewal Penalty Alert
                            </h3>
                            <p className="text-xs font-bold text-rose-700 mt-0.5">
                                This renewal is past the 24-hour grace period. A{" "}
                                <strong>20% Penalty</strong> will be
                                automatically applied to the new monthly rent
                                upon saving.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full bg-white border-2 rounded-lg px-4 py-2 text-sm font-bold focus:ring-0 ${errors.start_date ? "border-rose-500 focus:border-rose-600" : "border-emerald-300 focus:border-emerald-600"}`}
                                required
                            />
                            {errors.start_date && (
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full bg-white border-2 rounded-lg px-4 py-2 text-sm font-bold focus:ring-0 ${errors.end_date ? "border-rose-500 focus:border-rose-600" : "border-emerald-300 focus:border-emerald-600"}`}
                                required
                            />
                            {errors.end_date && (
                                <p className="text-[10px] font-bold text-rose-500 mt-1 uppercase">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full bg-white border-2 rounded-lg px-4 py-2 text-sm font-black focus:ring-0 ${errors.monthly_rent ? "border-rose-500 focus:border-rose-600" : "border-emerald-300 focus:border-emerald-600"}`}
                                required
                            />
                            {errors.monthly_rent && (
                                <p className="text-[10px] font-bold text-rose-500 mt-1 uppercase">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <textarea
                                ...
                                rows={2}
                                className="w-full bg-white border-2 border-emerald-300 rounded-lg px-4 py-2 text-sm font-bold text-emerald-900 focus:border-emerald-600 focus:ring-0 custom-scrollbar"
