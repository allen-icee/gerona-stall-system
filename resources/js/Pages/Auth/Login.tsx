        ...
        <GuestLayout>
            ...
            <div className="text-center mb-8">
                <div className="bg-yellow-100 w-16 h-16 flex items-center justify-center rounded-full mx-auto mb-4">
                    <Icon icon="solar:lock-keyhole-bold-duotone" className="w-8 h-8 text-yellow-600" />
                </div>
            ...
            <form onSubmit={submit} className="space-y-5">
                <div>
                    <label htmlFor="username" className="text-xs font-bold text-slate-600 uppercase mb-1.5 block tracking-wide">
                        Username
                    </label>
                    <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <Icon icon="solar:user-bold-duotone" className="h-5 w-5 text-slate-400" />
                        </div>
                        <input
                            id="username"
                            type="text"
                ...
                <div>
                    <label htmlFor="password" className="text-xs font-bold text-slate-600 uppercase mb-1.5 block tracking-wide">
                        Password
                    </label>
                    <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <Icon icon="solar:lock-password-bold-duotone" className="h-5 w-5 text-slate-400" />
                        </div>
                        <input
                            id="password"
                        ...
                        >
                            <Icon icon={showPassword ? "solar:eye-bold-duotone" : "solar:eye-closed-bold-duotone"} className="h-5 w-5" />
                        </button>
                    </div>
                </div>
