...
export default function ToastListener() {
    ...
    useEffect(() => {
        ...
        if (newToast) {
            ...
            // 🔥 SET NEW TIMERS (these will NOT be interrupted)
    ...
    return (
        <div
            className={`fixed bottom-8 left-1/2 z-[9999] w-full max-w-md transition-all duration-300 ease-out transform ${isVisible
        ...
        >
            <div className="flex items-center w-full gap-4 px-4 py-3 bg-white border-2 border-slate-300 rounded-xl shadow-xl">
                <div
                    className={`flex items-center justify-center p-2.5 rounded-lg shrink-0 ${isSuccess
